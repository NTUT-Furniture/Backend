...
from app.model.image import Image, ImageIOFailModel, ImageTypeEnum
...
async def upload_image(
        ...
        img_type: ImageTypeEnum = ImageTypeEnum.avatar,
        file: UploadFile = File(...)
):
    if img_type == ImageTypeEnum.banner:
    ...
    elif img_type == ImageTypeEnum.avatar:
